...
public class TinyDB {
    ...
    public ArrayList<AlatDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<AlatDomain> playerList =  new ArrayList<AlatDomain>();

        for(String jObjString : objStrings){
            AlatDomain player  = gson.fromJson(jObjString,  AlatDomain.class);
    ...
    public void putListObject(String key, ArrayList<AlatDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(AlatDomain player: playerList){
